import type { ArticleInList } from "@/types/article";
import { Card, CardHeader, Badge, CardContent, CardFooter, Button } from "@/components/ui";
import { Heart, MessageCircle, Eye, ImageIcon, User } from "lucide-react"; 
        ...
        <Card className="overflow-hidden flex flex-col h-full">
            ...
            <CardFooter className="flex justify-between items-center pt-2 px-4 pb-3 flex-shrink-0 mt-auto">
                ...
                <Link to={`/articles/${article.id}`}>
                    <Button
                        variant="link"
                        className="cursor-pointer text-xs p-0 h-auto"
                    >
                        Read More
                    </Button>
                </Link>
