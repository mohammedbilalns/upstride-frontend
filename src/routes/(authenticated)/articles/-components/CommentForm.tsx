...
import { commentSchema, type CreateCommentData } from "../-validations/comment.validation";
    ...
    <div className={`flex gap-3 ${containerClass} ${className}`}>
      ...
      <div className="flex-1">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={`flex ${isReply ? "justify-end gap-2" : "justify-end"} mt-${isReply ? "2" : "3"}`}>
            {isReply && onCancel && (
              <Button
                type="button"
