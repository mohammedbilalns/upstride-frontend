...
const handleImageChange = (image: CloudinaryResponse | null) => {
    form.setValue("featuredImage", image || undefined, { shouldValidate: true });
		...
		<div className="container mx-auto px-4 py-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				...
				<div className="flex flex-col space-y-6">
					<FeaturedImageUpload onImageChange={handleImageChange}     error={form.formState.errors.featuredImage?.message}
					/>
