...
import { useFetchArticle } from "@/features/articles/hooks/article-queries.hooks";
import { useUpdateArticle } from "@/features/articles/hooks/article-mutations.hooks";
...
function RouteComponent() {
	...
	if (isLoading) {
		return (
			<div className="container mx-auto px-4 py-6">Loading article...</div>
		);
	}
