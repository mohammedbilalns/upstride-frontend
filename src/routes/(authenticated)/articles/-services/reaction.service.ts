...
export async function reactResource(resourceId: string, reaction: "like" | "dislike", resourceType:"article" | "comment") {
	try {

		const response = await api.post(API_ROUTES.REACT.REACT_RESOURCE, {resourceId, reaction,resourceType})
