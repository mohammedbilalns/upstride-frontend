...
const dummyMessages: Record<string, Message[]> = {
  '1': [
    ...
    {
      id: '1-3',
      content: 'I\'ve been implementing the leadership strategies we discussed, and they\'re making a real difference.',
    ...
    {
      id: '1-4',
      content: 'That\'s wonderful to hear! Which strategies have been most effective for you?',
    ...
    {
      id: '1-5',
      content: 'The regular check-ins and focusing on outcomes rather than activity. Looking forward to our next session!',
      timestamp: '2024-01-15T10:30:00',
      isOwn: true,
      isRead: true
    }
  ...
  '2': [
    ...
    {
      id: '2-3',
      content: 'I\'ve had two interviews already, and your tips really helped me prepare.',
