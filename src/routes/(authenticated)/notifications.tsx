...
const dummyNotifications: Notification[] = [
	...
	},
	{
		...
		title: "New Comment",
		description:
			'Emma Thompson commented on your post: "Great insights on personal branding!"',
		time: "5 hours ago",
		isRead: true,
		actions: [
	...
	},
	{
		...
		description:
			'Sarah Williams published "5 Strategies for Effective Remote Leadership"',
		time: "1 day ago",
		isRead: true,
		actions: [
	...
	},
	{
		...
		description:
			"Your session with Michael Chen scheduled for tomorrow has been canceled",
		time: "3 days ago",
		isRead: true,
		actions: [
