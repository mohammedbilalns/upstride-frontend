...
const dummySessions: Session[] = [
  {
    ...
    description: 'One-on-one coaching session focusing on remote team leadership strategies and conflict resolution.',
    date: '2024-01-15',
    time: '14:00',
    duration: '1 hour',
    status: 'upcoming',
  ...
  },
  {
    ...
    description: 'Discussing career progression in tech industry and setting goals for the next 2 years.',
    date: '2024-01-20',
    time: '11:00',
    duration: '45 minutes',
    status: 'upcoming',
  ...
  },
  {
    ...
    description: 'Interactive workshop on building and managing high-performing teams.',
    date: '2024-01-10',
    time: '15:00',
    duration: '2 hours',
    status: 'completed',
  ...
  },
  {
    ...
    description: 'Developing a personal brand strategy for professional growth.',
    date: '2024-01-08',
    time: '10:00',
    duration: '1 hour',
    status: 'completed',
...
function RouteComponent() {
  ...
  const pastSessions = dummySessions.filter(s => s.status === 'completed' || s.status === 'canceled');
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="flex items-center text-sm text-muted-foreground">
                          ...
                          <span>{session.meetingLink ? 'Online' : session.location}</span>
                        </div>
                      </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex justify-between items-center">
                        <div className="text-sm text-muted-foreground">
                          {session.status === 'completed' ? 'Session completed successfully' : 'Session was canceled'}
                        </div>
                        <Button variant="outline">
                          View Details
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">{dummySessions.filter(s => s.status === 'completed').length}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Canceled</span>
                <span className="font-semibold">{dummySessions.filter(s => s.status === 'canceled').length}</span>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <Avatar className="h-10 w-10">
                      <AvatarImage src={upcomingSessions[0].mentor.imageUrl} alt={upcomingSessions[0].mentor.name} />
                      <AvatarFallback>{upcomingSessions[0].mentor.name.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                    </Avatar>
                    <div className="flex-1">
                      <p className="text-sm font-medium">{upcomingSessions[0].title}</p>
                      <p className="text-xs text-muted-foreground">
                        {upcomingSessions[0].mentor.name} • {formatDate(upcomingSessions[0].date)}
                      </p>
                    </div>
                  </div>
