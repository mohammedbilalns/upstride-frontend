...
import { useApproveMentor } from "@/features/admin/mentor-management/hooks";
import { useRejectMentor } from "@/features/admin/mentor-management/hooks";
...
export const Route = createFileRoute("/(admin)/admin/mentormanagement/")({
