...
import { User, MoreHorizontal, Heart, ChevronDown, ChevronUp, Edit } from "lucide-react";
	...
	return (
		<div className={level > 0 ? "ml-6 mt-4" : ""}>
			...
			<CommentReplies
				...
				parentCommentId={comment.id}  // ← This passes current comment's ID to CommentReplies
			/>
		</div>
	);
}
