...
import { mentorQueryOptions } from "@/features/mentor-discovery/services/mentor.service";
import { useUpdateMentorProfile } from "@/features/mentor-discovery/dashboard/hooks/mentor-dashboard-mutations.hooks";
...
export default function UserProfilePage({ auth }: UserProfilePageProps) {
  const { data: mentor } = useSuspenseQuery(mentorQueryOptions());
