...
export default function MentorSideBar({ search, navigate }: MentorSideBarProps) {
  const { data: ExpertisesAndSkillsData, isLoading: isLoadingFilters } = useFetchActiveExpertisesAndSkills();
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                {ExpertisesAndSkillsData?.expertises?.map((expertise: {id: string, name: string}) => (
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                {ExpertisesAndSkillsData?.skills?.map((skill: {id: string, name: string}) => (
