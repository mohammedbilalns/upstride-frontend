...
import MentorRegisterForm from "@/features/mentor-discovery/registration/components/MentorRegisterForm";
        ...
        <Card className="border-green-200 bg-green-50 w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            <p className="text-green-700">
              Thank you for applying to become a mentor! Your application has
              been submitted and is currently under review.
            </p>
            <p className="text-green-600">
              We'll notify you via email once a decision has been made. This
          ...
          <CardContent className="text-center space-y-6">
            <div className="space-y-2">
              <p className="text-red-700">
                We're sorry, but your mentor application wasn't approved at this
                time.
              </p>
              <p className="text-red-600">
                Thank you for your interest in becoming a mentor! Our program
                has specific requirements that change as our community's needs
                evolve. We hope you'll consider applying again in the future
                when your expertise better matches what our mentees are seeking.
              </p>
            </div>
            <Button
